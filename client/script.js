...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get('http://localhost:3000/repeat/' + 'lucas').then((response) => {
...
const attachQuery = () => {
    axios.get('http://localhost:3000/query-test' + '?name=').then((res) => {
...
/*
    ...
    1: Send no queries on the URL -- what happened? It says You sent query: name with value: !

    2: Send more than 1 query on the URL -- what happened?  It says the a send a empity query
*/
